...
In this paper, the researchers explore the effect of empthetic non-verbal 
communication on patient perception of clinitian empathy, warmth and 
competence. The goal of the project is to show that when a clinitian 
displays empathetic body language, patients will precieve the clinitian as
having more empathy, warmth, and importantly competence than a clinitian 
does not display these characteristics. The key here is show that, in a
clinical setting, perceptions of empathy are not negativly correlated with 
perceptions of competence as they have been shown to be in other settings.

The data consisted consisted of responses to a survey performed on Amazon 
...
then shown a series of 6 photographs showing a clinitian that is 
...
leaned back, arms crossed, disintrested look on face) and each wearing 
either the traditional physican white coat or more regular clothing. This
made four different types of pictures that could be shown. Each subject saw 
either 6 empethetic pictures or 6 unempethetic pictures, never a mix. In 
each of the pictures the clinician would either be wearing a white coat or
not, never both.Each of these pictures was acompanied with 1 to 3 lines of 
script that mimiced a conversation between a doctor and a patient where the
doctor was recomending surgery over medical treatment. Durring this time, 
...
non-verbal behavior a subject was exposed to (empathetic / unempethetic), 
the responces to the PANAS, CARE, and Fiske's surveys, and the subjects 
sex.

The indepentent variables of interest in the experiment were the category of 
non-verbal behavior a subject was exposed to (empathetic / unempethetic),
...
the experement were the emotional states of the participants coming into the
experiment as measured through the positive and negative PANAS survey.

The researchers come to the conclusion that there is a strong corelation 
between empathetic non-verbal behavior in subject precieved empathy and warmth.
...
subject of the experiment it was discussed in detail. Lets first explor the 
...
an analysis that does not explicitly seperate the results based on sex will
...
two seperate studies. The first run had N=194 participants, all wore white 
...
in each study. This corresponds to studiy 2.
...
As discussed earlier the, the reseachers found that there was no signifigant 
effect of the clinician wearing a white coat and thus dropped it from the study.
This resulted in the colapsing of the plot shown above into one group, only 
...
exposed to a clinician displayin empathetic non-verbal behavior as there were
...
variables seperated by the sex of the subject.
...
We can see that there is no signifigant difference between in the responses 
between males and females.

Now lets look at the same correlation between dependent variables but seperating
...
In this case we can see that there is a large difference between empethetic
...
there is a signifigant difference in the competence is one of the main 
...
Here we can see that there apears to be a strong positive effect of positive 
